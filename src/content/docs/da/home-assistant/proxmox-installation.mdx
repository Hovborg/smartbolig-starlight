...
<img src="/images/guides/proxmox-installation/hero.jpg" alt="Proxmox Home Assistant installation" style="border-radius: 12px; margin-bottom: 1.5rem;" />
...
| **Network** | `VirtIO` | Bedste netværks performance |
