...
<Steps>
1. **Behold standardindstillingen** i Tasmota:
   ```
   SetOption19 0
   ```
   Den officielle Tasmota-integration bruger Tasmotas egen discovery og kræver `SetOption19 0` (standard). `SetOption19 1` skifter til legacy MQTT discovery og fjerner enhederne fra integrationen.
