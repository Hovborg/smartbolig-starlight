...
description: Byg en bevægelsessensor med ESP32 og PIR sensor til automatisk lysstyring.
sidebar:
  badge:
    text: Let
    variant: success
...
<img src="/images/guides/bevaegelsessensor/hero.jpg" alt="PIR bevægelsessensor" style="border-radius: 12px; margin-bottom: 1.5rem;" />
