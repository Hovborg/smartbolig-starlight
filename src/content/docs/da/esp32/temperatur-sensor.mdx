...
description: Byg en præcis temperatur og fugtighed sensor med ESP32 og DHT22. Komplet guide.
sidebar:
  badge:
    text: Populær
    variant: tip
...
<Aside type="danger" title="⚠️ Brug kun 3.3V!">
...
Hvis temperaturen viser forkert, juster `offset` værdien. F.eks. `offset: -1.5` trækker 1.5°C fra målingen.
</Aside>
...
**Tjek disse ting:**
1. Er ledningerne sat rigtigt i? (VCC→3.3V, ikke 5V!)
...
<CardGrid>
  ...
  <Card title="💡 LED Strip" icon="setting">
    Styr adresserbare RGB LEDs baseret på temperatur.
