...
OpenAI anbefaler aktuelt `gpt-5.5` til de fleste Codex-opgaver, og du kan også bare lade Codex bruge standardmodellen. Du kan vælge model ved start:
...
| `codex --sandbox workspace-write` | Arbejd i workspace med approvals ved risikable handlinger. Brug i rene Git-repos. |
...
Til rutineopgaver kan `gpt-5.5-mini` give længere local-message limits end de tungere modeller. Brug `gpt-5.5` til svær debugging, arkitektur og ændringer med høj risiko.
