...
Google lukker Gemini CLI's gratis adgang (Google-login), Google AI Pro og Google AI Ultra den 18. juni 2026. Herefter kræver Gemini CLI en betalt Gemini API-nøgle eller en Code Assist Standard/Enterprise-licens. Googles efterfølger er Antigravity CLI.
</Aside>
