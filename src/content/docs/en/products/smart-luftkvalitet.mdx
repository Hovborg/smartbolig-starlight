...
slug: produkter/smart-luftkvalitet
sidebar:
  badge:
    text: Guide
    variant: note
...
## 📊 Airthings (Native HA - 3,034 users)
...
<Tabs>
  <TabItem label="Overview">
    ...
    **Local API without cloud:**
    ...
    Awair Element supports **local polling** every 30 seconds - no cloud dependency! Enable via Awair app → Device Settings → Enable Local API.
    </Aside>
  </TabItem>
  <TabItem label="Home Assistant">
    ### Native Integration
...
## 🔧 AirGradient ONE (ESPHome - Recommended DIY)
...
<CardGrid>
  <Card title="Smart Water" icon="rocket">
    ...
    [See guide →](/en/produkter/smart-vand/)
  </Card>
