...
## 🌊 Flo by Moen (Native HA - Recommended)
...
<Tabs>
  <TabItem label="Overview">
    ...
    **AI-powered leak detection:**
    ...
    - ✅ Learns your home's water pattern
    - ✅ Detects leaks before they grow
    - ✅ Automatic water shutoff
    - ✅ Freeze alert
    - ⚠️ No native HA integration
    - ⚠️ IFTTT or custom API only
    - ❌ Requires plumber installation
...
## 📡 Zigbee Leak Sensors (Recommended DIY)
...
<Tabs>
  <TabItem label="Aqara Water Leak">
    ...
    **The most popular Zigbee sensor:**
    ...
    - ✅ IP67 waterproof
    - ✅ Detects 0.5mm water
    - ✅ CR2032 battery (2+ years)
    - ✅ Temperature sensor
    - ✅ HomeKit (via Aqara Hub)
    - ⚠️ Works with Z2M/ZHA (unofficial)
  ...
  <TabItem label="ThirdReality">
    ...
    **Officially Home Assistant compatible:**
    ...
    - ✅ Drip detection
    - ✅ AAA batteries (easier replacement)
    - ✅ Works with HA badge
    - ✅ Works with all Zigbee hubs
...
<Tabs>
  <TabItem label="Aqara Valve T1">
    ...
    **Best Zigbee water valve:**
    ...
    - ✅ Zigbee 3.0 + Matter
    - ✅ Fits DN15/DN20/DN25 (½", ¾", 1")
    - ✅ 4x AA batteries (2 years)
    - ✅ Manual backup on power failure
  ...
  <TabItem label="Tuya/MOES Zigbee">
    ...
    **Budget alternative:**
    ...
    - ✅ Zigbee or WiFi versions
    - ✅ Fits standard ball valves
    ...
    action:
      - service: notify.mobile_app
        data:
          ...
          message: >
            Water temperature: {{ states('sensor.water_pipe_temperature') }}°C
...
<CardGrid>
  <Card title="Smart Alarm" icon="shield">
    ...
    [See guide →](/en/produkter/smart-alarm/)
  </Card>
