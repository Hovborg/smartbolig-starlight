...
![LD2410 mmWave overview](/images/guides/ld2410-mmwave/overview.svg)
...
![LD2410 mmWave to ESP32 wiring diagram](/images/guides/ld2410-mmwave/wiring-en.svg)
...
ld2410:
  id: ld2410_sensor
  uart_id: ld2410_uart
  # Note: Since ESPHome 2023.8 the ld2410 hub block only accepts id + uart_id.
  # Tuning (timeout, max distances, gate thresholds) is now done at runtime via
  # the number entities in Home Assistant.
