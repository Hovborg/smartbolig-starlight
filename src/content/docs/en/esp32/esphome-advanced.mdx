...
<img src="/images/guides/esphome-avanceret/hero.jpg" alt="ESPHome advanced programming" style="border-radius: 12px; margin-bottom: 1.5rem;" />
...
<CardGrid>
  <Card title="Temperature Sensor" icon="seti:arduino">
    ...
    [See guide →](/en/esp32/temperature-sensor/)
  </Card>
  <Card title="mmWave Sensor" icon="rocket">
    Advanced presence detection.
    
    [See guide →](/en/esp32/ld2410-mmwave/)
  </Card>
</CardGrid>
