...
| Guide | Description |
|-------|-------------|
| [Temperature Sensor](/en/esp32/temperatur-sensor/) | DHT22/DS18B20 temperature & humidity |
| [Motion Sensor](/en/esp32/bevaegelsessensor/) | PIR sensor for presence detection |
...
| [Bluetooth Proxy](/en/esp32/bluetooth-proxy/) | Extend Home Assistant BLE coverage over Wi-Fi, Ethernet or PoE |

<LinkCard
  title="ESPHome Bluetooth Proxy"
  description="Flash, place and troubleshoot a reliable remote BLE adapter"
