...
- ✅ Soldering iron (or strips with connectors)
- ✅ 5V power supply (at least 3A)
...
<Aside type="caution" title="⚡ Power supply is important!">
...
2. Go to **Home Assistant** → **Overview**
...
<Aside type="tip">
Want WLED? Flash it via [install.wled.me](https://install.wled.me) directly in browser!
</Aside>
...
<CardGrid>
  ...
  <Card title="🤖 Automations" icon="setting">
    ...
    [Learn automations →](/en/home-assistant/first-automation/)
  </Card>
</CardGrid>
