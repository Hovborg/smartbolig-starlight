...
heroImage:
  ...
  alt: "SmartBolig hardware visual about today's AI news from OpenAI Codex, OpenClaw, Claude Code, Gemini CLI, OpenAI, and Google AI"
  caption: "SmartBolig hardware arranged for today's AI news about Codex, Chrome AI, Gemini, and agent workflows."
news:
  signal: high
  sources:
