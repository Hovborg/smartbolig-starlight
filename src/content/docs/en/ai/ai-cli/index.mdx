...
description: Compare Codex CLI, Claude Code, and Gemini CLI, then choose a safe way to start using an AI assistant in your own projects.
sidebar:
  badge:
    text: Start here
    variant: success
...
| Already use Google/Gemini | Start with [Antigravity CLI (agy)](/en/ai/ai-cli/antigravity-cli-kom-godt-i-gang/) — Gemini CLI's free access shuts down June 18, 2026. |
| Want to compare them | Read [Codex vs Claude Code vs Gemini CLI vs agy](/en/ai/ai-cli/sammenligning/) after trying one small task. |
...
<CardGrid>
  ...
  <Card title="Start with Antigravity CLI (agy)" icon="puzzle">
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Install Google's new agy CLI — the successor to Gemini CLI. A single fast binary with MCP support."
    href="/en/ai/ai-cli/antigravity-cli-kom-godt-i-gang/"
  />
  <LinkCard
