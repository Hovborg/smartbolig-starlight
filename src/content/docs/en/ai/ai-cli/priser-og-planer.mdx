...
Google is shutting down Gemini CLI's free access (Google sign-in, Gemini Code Assist for individuals), Google AI Pro, and Google AI Ultra on June 18, 2026. After that, only paid Gemini API keys and Code Assist Standard/Enterprise licenses keep working with Gemini CLI. The free and consumer quotas below therefore only apply until that date. Google's successor is Antigravity CLI.
</Aside>
