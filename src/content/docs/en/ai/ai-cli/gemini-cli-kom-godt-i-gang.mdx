...
<Aside type="caution" title="Important change on June 18, 2026">
Google is shutting down Gemini CLI's free access (Google sign-in), Google AI Pro, and Google AI Ultra on June 18, 2026. After that, Gemini CLI requires a paid Gemini API key or a Code Assist Standard/Enterprise license. Google's successor is [Antigravity CLI (agy) — see our guide](/en/ai/ai-cli/antigravity-cli-kom-godt-i-gang/).
</Aside>
...
<Tabs>
  ...
  <TabItem label="Homebrew">
    ...
    Note: this Homebrew formula is deprecated as of June 18, 2026, when Gemini CLI's free access is shut down (see the warning at the top).
  </TabItem>
</Tabs>
