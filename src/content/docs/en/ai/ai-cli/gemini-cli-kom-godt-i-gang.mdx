...
Google is shutting down Gemini CLI's free access (Google sign-in), Google AI Pro, and Google AI Ultra on June 18, 2026. After that, Gemini CLI requires a paid Gemini API key or a Code Assist Standard/Enterprise license. Google's successor is Antigravity CLI.
</Aside>
