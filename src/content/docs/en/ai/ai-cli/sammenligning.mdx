...
All four tools can do expensive or dangerous things if you give them broad access. Use Git, worktrees, spend limits, and diff review. Do not let an agent work freely in folders with tokens, private keys, or customer data.
</Aside>
