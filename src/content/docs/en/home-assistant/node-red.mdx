...
<img src="/images/guides/node-red/hero.jpg" alt="Node-RED visual programming" style="border-radius: 12px; margin-bottom: 1.5rem;" />
...
Menu → Manage palette → Install → Search "stoptimer"
</Aside>
