...
<img src="/images/guides/zigbee2mqtt-avanceret/hero.jpg" alt="Zigbee2MQTT advanced" style="border-radius: 12px; margin-bottom: 1.5rem;" />
...
<FAQ questions={[
  {
    ...
    answer: "No! Firmware updates on the coordinator preserve all paired devices. You just need to update the adapter type in configuration (e.g., ezsp → ember)."
  },
  {
...
<CardGrid>
  <Card title="Zigbee Sensors" icon="seti:arduino">
    ...
    [See guide →](/en/products/zigbee-sensors/)
  </Card>
