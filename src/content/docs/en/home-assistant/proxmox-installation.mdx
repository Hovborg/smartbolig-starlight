...
<img src="/images/guides/proxmox-installation/hero.jpg" alt="Proxmox installation" style="border-radius: 12px; margin-bottom: 1.5rem;" />
...
- ✅ Access to Proxmox shell (SSH or web console)
