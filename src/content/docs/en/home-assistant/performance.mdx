...
<img src="/images/guides/performance/hero.jpg" alt="Performance optimization" style="border-radius: 12px; margin-bottom: 1.5rem;" />
...
<CardGrid>
  <Card title="Backup & Security" icon="shield">
    ...
    [See guide →](/en/home-assistant/backup-security/)
  </Card>
