...
## 🏆 Ready-Made mmWave Sensors

### Comparison

| Sensor | Protocol | Zones | Multi-person | Price ~ | Score |
|--------|----------|-------|--------------|---------|-------|
| **Aqara FP2** | WiFi/HomeKit | ✅ 30 zones | ✅ 5 people | $85 | ⭐⭐⭐⭐⭐ |
...
<Tabs>
  ...
  <TabItem label="Installation">
    ...
    2. Add Integration → HomeKit Controller
