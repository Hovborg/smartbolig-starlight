...
- Fixed Windows news-runner argument forwarding: Git's `-C` no longer binds to the wrapper's command parameter. Added a regression in Windows PowerShell 5.1 and PowerShell 7, including paths with spaces and native failures.
